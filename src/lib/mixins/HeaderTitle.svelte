...
<h1 {...props}>
  <div class='absolute inset-0 screen p-8'>
    <svg
      ...
      class='pointer-events-none m-auto full rotate-z--10 fill-transparent stroke-4 object-contain transition-filter-200 aber-drop lg:container lg:stroke-1 md:stroke-2'
