...
>
  ...
  <ul
    class='
      group/ul mx-auto grid grid-cols-1 gap-3
      xs:grid-cols-2
      md:grid-cols-3
      lg:grid-cols-4
      xl:gap-5
  ...
  >
    {#each nameSel as [name, isSel] (name)}
      ...
      >
        <a
          class='
            group/a relative border border-transparent transition
            group-focus-within/ul:opacity-50
            group-has-[a:hover]/ul:opacity-50
            hover:border-bord-400 hover:opacity-100!
            focus:border-bord-400 focus:opacity-100!
            aria-disabled:pointer-events-none aria-disabled:opacity-25!
          '
          aria-disabled={!isSel}
          aria-label={title}
        ...
        >
          <div
            class='
              ...
              group-hover/a:translate-y-0 group-hover/a:opacity-100
              group-focus/a:translate-y-0 group-focus/a:opacity-100
