...
const load$1 = (element, settings, instance) => {
...
const onEnter = (element, entry, settings, instance) => {
    ...
    load$1(element, settings, instance);
};
...
window.scroll = new smoothScroll_polyfills_min('a[href*="#"]', {
  updateURL: false,
