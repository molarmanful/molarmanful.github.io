  ...
  shortcuts: [
    {
      ...
      'h-s-dvh': 'h-vh supports-[(height:100dvh)]:h-dvh',
      'max-h-s-lvh': 'max-h-vh supports-[(max-height:100lvh)]:max-h-lvh',
      'max-h-s-dvh': 'max-h-vh supports-[(max-height:100dvh)]:max-h-dvh',
      'screen': 'w-screen h-s-lvh',
      'dscreen': 'w-screen h-s-dvh',
      'max-screen': 'max-w-screen max-h-s-lvh',
      'max-dscreen': 'max-w-screen max-h-s-dvh',
      'full': 'w-full h-full',
